...
export default function PackagesSection() {
  ...
  return (
    <section id="packages" className="py-20 bg-gradient-to-b from-white to-amber-50">
      <div className="max-w-7xl mx-auto px-4">
        {/* Header */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <option value="short">7-10 Days</option>
            <option value="medium">10-14 Days</option>
