...
export default function FlightsSection() {
  ...
  return (
    <section id="flights" className="py-20 bg-gradient-to-b from-amber-50 to-white">
      <div className="max-w-7xl mx-auto px-4">
        {/* Header */}
        <motion.div
                ...
                <div className="bg-gray-50 rounded-xl p-4 mb-4">
                  <div className="flex items-center justify-between">
                    <div className="text-center">
                      ...
                      <div className="text-sm font-medium">{flight.sampleTiming.split(' - ')[0]}</div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm font-medium">{flight.sampleTiming.split(' - ')[1]}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {flight.features.map((feature, i) => (
                      <span key={i} className="bg-green-100 text-green-800 px-2 py-1 rounded-lg text-xs flex items-center gap-1">
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-3xl p-8 max-w-3xl mx-auto">
