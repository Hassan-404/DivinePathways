...
export default function AboutSection() {
  ...
  return (
    <section data-editor-id="app/components/AboutSection.tsx:38:5" id="about" className="py-20 bg-gradient-to-b from-white to-amber-50">
      <div data-editor-id="app/components/AboutSection.tsx:39:7" className="max-w-7xl mx-auto px-4">
        {/* Header */}
        <motion.div
          ...
          <h2 data-editor-id="app/components/AboutSection.tsx:48:11" className="text-4xl md:text-5xl font-light text-gray-900 mb-6">
            <span data-editor-id="app/components/AboutSection.tsx:42:13">About</span>{' '}
            <span data-editor-id="app/components/AboutSection.tsx:50:13" className="bg-gradient-to-r from-amber-600 to-amber-700 bg-clip-text text-transparent font-medium">
              <span data-editor-id="app/components/AboutSection.tsx:44:15">Divine Pathways</span>
            </span>
          </h2>
          <p data-editor-id="app/components/AboutSection.tsx:54:11" className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          <div data-editor-id="app/components/AboutSection.tsx:67:11" className="text-center">
            <Icon icon="material-symbols:mosque" className="text-6xl text-amber-600 mb-6" />
            <h3 data-editor-id="app/components/AboutSection.tsx:69:13" className="text-2xl md:text-3xl font-semibold text-gray-900 mb-6">
              <span data-editor-id="app/components/AboutSection.tsx:63:15">Our Mission</span>
            </h3>
            <p data-editor-id="app/components/AboutSection.tsx:72:13" className="text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto">
            ...
            <p data-editor-id="app/components/AboutSection.tsx:75:13" className="text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto mt-4">
        ...
        <motion.div
          ...
          <motion.div
            ...
            className="text-center bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div data-editor-id="app/components/AboutSection.tsx:99:15" className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:91:17">{stat.number}</span>
              </div>
              <div data-editor-id="app/components/AboutSection.tsx:102:15" className="text-gray-600 text-sm">
        ...
        <motion.div
          ...
          <h3 data-editor-id="app/components/AboutSection.tsx:117:11" className="text-3xl font-semibold text-center text-gray-900 mb-12">
            <span data-editor-id="app/components/AboutSection.tsx:108:13">Our Core Values</span>
          </h3>
          <div data-editor-id="app/components/AboutSection.tsx:120:11" className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="flex items-start gap-4">
                ...
                <div data-editor-id="app/components/AboutSection.tsx:130:17" className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <Icon icon={value.icon} className="text-2xl text-amber-600" />
                </div>
                <div data-editor-id="app/components/AboutSection.tsx:133:17">
                  <h4 data-editor-id="app/components/AboutSection.tsx:134:19" className="text-xl font-semibold text-gray-900 mb-3">
                    <span data-editor-id="app/components/AboutSection.tsx:125:21">{value.title}</span>
                  </h4>
                  <p data-editor-id="app/components/AboutSection.tsx:137:19" className="text-gray-600 leading-relaxed">
        ...
        <motion.div
          ...
          <h3 data-editor-id="app/components/AboutSection.tsx:155:11" className="text-2xl md:text-3xl font-semibold text-gray-900 mb-6">
            <span data-editor-id="app/components/AboutSection.tsx:145:13">Fully Licensed & Accredited</span>
          </h3>
          <p data-editor-id="app/components/AboutSection.tsx:158:11" className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto mb-8">
          ...
          <div data-editor-id="app/components/AboutSection.tsx:161:11" className="flex flex-wrap justify-center gap-6">
            <div data-editor-id="app/components/AboutSection.tsx:162:13" className="bg-white rounded-lg px-6 py-3 shadow-md">
              <span data-editor-id="app/components/AboutSection.tsx:152:15" className="font-semibold text-gray-900">ATOL Protected</span>
            </div>
            <div data-editor-id="app/components/AboutSection.tsx:165:13" className="bg-white rounded-lg px-6 py-3 shadow-md">
              <span data-editor-id="app/components/AboutSection.tsx:155:15" className="font-semibold text-gray-900">ABTA Member</span>
            </div>
            <div data-editor-id="app/components/AboutSection.tsx:168:13" className="bg-white rounded-lg px-6 py-3 shadow-md">
        ...
        <motion.div
          ...
          <h3 data-editor-id="app/components/AboutSection.tsx:182:11" className="text-3xl font-semibold text-gray-900 mb-8">
            <span data-editor-id="app/components/AboutSection.tsx:171:13">Meet Our Expert Team</span>
          </h3>
          <div data-editor-id="app/components/AboutSection.tsx:185:11" className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-editor-id="app/components/AboutSection.tsx:186:13" className="text-center">
              <img data-editor-id="app/components/AboutSection.tsx:187:15"
              src="https://i.pravatar.cc/150?u=founder"
              alt="Founder"
              className="w-24 h-24 rounded-full mx-auto mb-4 shadow-lg" />

              <h4 data-editor-id="app/components/AboutSection.tsx:192:15" className="text-xl font-semibold text-gray-900 mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:182:17">Ahmed Khan</span>
              </h4>
              <p data-editor-id="app/components/AboutSection.tsx:195:15" className="text-amber-600 font-medium mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:185:17">Founder & CEO</span>
              </p>
              <p data-editor-id="app/components/AboutSection.tsx:198:15" className="text-gray-600 text-sm">
            ...
            <div data-editor-id="app/components/AboutSection.tsx:202:13" className="text-center">
              <img data-editor-id="app/components/AboutSection.tsx:203:15"
              src="https://i.pravatar.cc/150?u=operations"
              alt="Operations Director"
              className="w-24 h-24 rounded-full mx-auto mb-4 shadow-lg" />

              <h4 data-editor-id="app/components/AboutSection.tsx:208:15" className="text-xl font-semibold text-gray-900 mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:198:17">Sarah Ahmed</span>
              </h4>
              <p data-editor-id="app/components/AboutSection.tsx:211:15" className="text-amber-600 font-medium mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:201:17">Operations Director</span>
              </p>
              <p data-editor-id="app/components/AboutSection.tsx:214:15" className="text-gray-600 text-sm">
            ...
            <div data-editor-id="app/components/AboutSection.tsx:218:13" className="text-center">
              <img data-editor-id="app/components/AboutSection.tsx:219:15"
              src="https://i.pravatar.cc/150?u=guide"
              alt="Head Guide"
              className="w-24 h-24 rounded-full mx-auto mb-4 shadow-lg" />

              <h4 data-editor-id="app/components/AboutSection.tsx:224:15" className="text-xl font-semibold text-gray-900 mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:214:17">Imam Abdullah</span>
              </h4>
              <p data-editor-id="app/components/AboutSection.tsx:227:15" className="text-amber-600 font-medium mb-2">
                <span data-editor-id="app/components/AboutSection.tsx:217:17">Head Spiritual Guide</span>
              </p>
              <p data-editor-id="app/components/AboutSection.tsx:230:15" className="text-gray-600 text-sm">
