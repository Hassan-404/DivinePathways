...
export default function PaymentCancelPage() {
  return (
    <div data-editor-id="app/payments/cancel/page.tsx:9:5" className="min-h-screen bg-gradient-to-br from-red-50 to-white flex items-center justify-center p-4">
      <motion.div
